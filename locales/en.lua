Locales['en'] = {
	...
	['garage'] = 'Garage',
	['notif_car_impounded'] = 'Your car has been impounded!',
	['notif_car_out'] = 'Your car is not in garage!',
	['status_in_garage'] = '%s: <font color="green">In Garage</font>',
	['status_out_garage'] = '%s: <font color="red">Out of Garage/font>',
	['status_impounded'] = '%s: <font color="blue">Impounded</font>',
	...
	['ranger'] = 'Your car has been stored in the garage!',
	['stockv_not_owned'] = 'This vehicle is not yours!',
	['stockv_not_in_veh'] = 'You need to be in a vehicle to store it!',
	...
	['impound_not_enough_money'] = 'You don\'t have enough money'
}
